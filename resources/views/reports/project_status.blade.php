...
@section('content')
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">{{trans('admin.nav_reports_with_project')}}</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">{{trans('admin.nav_reports_with_project')}}</li>
        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                  {{ Form::open( ['url' => ['project_status'],'method'=>'post'] ) }}
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>&nbsp;</label>
                                           <h4>{{trans('admin.search_project_status')}}</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                   @foreach($project as $project)
                                        <tr>
                                            <th class="center">{{$project->Projectname_ar}}</th>
                                            <th class="center">
...
@endphp
                                    ...
                                    {{$status->title_ar}}
                                        ...
                                        @endif
                                            ...
                                            <th class="center">{{$project->registration_date}}</th>
